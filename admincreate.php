        ...
        <div>
          ...
          <tbody class="tbody">
            ...
            <tr class="tbody_1">
              ...
              <td><button class="edit"><a href="<?php echo base_url().'index.php/Newlogin/edit/'.$task['item_id']?>" >Edit</button></a>
               <button class="delete"><a href="<?php echo base_url().'index.php/Newlogin/delete/'.$task['item_id']?>">Delete</button></a>
            </td>
